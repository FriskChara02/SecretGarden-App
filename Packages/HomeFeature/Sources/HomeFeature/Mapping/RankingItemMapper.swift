//
//  RankingItemMapper.swift
//  HomeFeature
//
//  Created by Loi Nguyen on 12/9/26.
//

// Map Series/RankingSortBy/RankingRange (CoreModels) <-> RankingItemData/DSRankingSortBy/DSRankingRange (DesignSystem)
// This is a parallel version of GroupHighlightMapper (SocialFeature)

import CoreModels
import DesignSystem
import Foundation

enum RankingItemMapper {
